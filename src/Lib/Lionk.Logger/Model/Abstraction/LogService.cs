...
public static class LogService
{
    ...
    ///     Throw
    ///     an argument null exception if loggerFactory is null.
    /// </exception>
    ...
    public static IStandardLogger? CreateLogger(string loggerName) => _loggerFactory?.CreateLogger(loggerName);
    ...
    public static void LogApp(LogSeverity severity, string message) => _appLogger?.Log(severity, message);

    /// <summary>
    ///     Log a debug message.
    /// </summary>
    /// <param name="message">Debug message.</param>
    public static void LogDebug(string message) => _debugLogger?.Log(LogSeverity.Debug, message);
