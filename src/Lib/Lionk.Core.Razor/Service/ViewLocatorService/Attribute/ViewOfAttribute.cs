...
public class ViewOfAttribute(string name, Type componentType, Type configurableView, ViewContext viewMode) : Attribute
{
    #region properties
    ...
    /// </summary>
    public ComponentViewDescription Description { get; } = new(
        name,
        componentType,
        configurableView,
        viewMode);
