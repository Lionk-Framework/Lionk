...
public abstract class BaseExecutableComponent : BaseComponent, IExecutableComponent
{
    ...
    protected virtual void OnExecute(CancellationToken cancellationToken) => IsRunning = true;
    ...
    /// </summary>
    protected virtual void OnInitialize() => _isInitialized = true;
    ...
    /// </summary>
    protected virtual void OnTerminate() => IsRunning = false;
