...
public class BaseCyclicComponentTests
{
    ...
    [SetUp]
    public void Setup()
        => _cyclicComponent = new TestableCyclicComponent();

    /// <summary>
    /// Tests that the <see cref="BaseCyclicComponent.OnInitialize"/> method sets the <see cref="BaseCyclicComponent.StartedDate"/> property correctly.
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Tests that the <see cref="BaseCyclicComponent.OnExecute(CancellationToken)"/> method increments the <see cref="BaseCyclicComponent.NbCycle"/> property.
    /// </summary>
    [Test]
    ...
    /// <summary>
    /// Tests that the <see cref="BaseCyclicComponent.OnTerminate"/> method sets the <see cref="BaseCyclicComponent.LastExecution"/> property to the current date and time.
    /// </summary>
    [Test]
